...
?>
	...
	<?php if (isset($images->image_intro) && !empty($images->image_intro)) : ?>
		...
		<div class="st-img-intro img-intro-<?php echo htmlspecialchars($imgfloat); ?>">
			...
			<div class="st-article-info-top">
				<?php 
					$time = strtotime($this->item->displayDate);
					$day = date("d", $time);
					$month = date("M", $time);
					$year = date("Y", $time);
				?>
				<div class="date">
					...
					<div class="month-year"><?php echo $month; ?> <?php echo $year; ?></div>
				</div>
