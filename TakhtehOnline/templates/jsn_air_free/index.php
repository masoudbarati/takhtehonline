	...
	?>
		...
		<div id="jsn-body">
			...
			?>
				...
				?>
					<div id="jsn-content-top" class="jsn-modulescontainer jsn-modulescontainer<?php echo $jsnutils->countModules('content-top'); ?>">
		...
		?>
			...
			<div id="jsn-brand">
				Joomla templates by <a href="http://www.joomlashine.com" title="Joomla templates by Joomlashine" target="_blank"><strong>Joomlashine</strong></a>
			</div>
		</div>
		<?php
			}
